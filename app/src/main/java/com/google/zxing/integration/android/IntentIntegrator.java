...
public class IntentIntegrator {
     ...
     *  {@link #startActivityForResult(Intent)} will be called on the {@link Fragment} instead
     *  of an {@link Activity}
     */
    ...
    private AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, int cameraId) {
        ...
        intentScan.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION & Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
